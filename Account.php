  ...
  <div class="container py-4">
    ...
    <div class="p-3 mb-4 bg-light rounded-3">
      <div class="container-fluid py-3">
        ...
        <p class="col-md-8 fs-4">Account ID: </p>
        <p class="col-md-8 fs-4">Account Balance: </p>
      ...
      <div class="p-3 mb-4 bg-light rounded-3">
        <div class="container-fluid py-3">
          ...
          <button class="w-50 btn btn-success btn-lg" type="submit">Withdraw money</button>
      ...
      <div class="p-3 mb-4 bg-light rounded-3">
        <div class="container-fluid py-3">
          ...
          <button class="w-50 btn btn-success btn-lg" type="submit">Send money</button>
