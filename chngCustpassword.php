  ...
  <div class="container py-4">
    ...
    <div class="p-3 mb-4 bg-light rounded-3">
      <div class="container-fluid py-3">
        ...
        <p class="col-md-8 fs-4">Customer's ID: </p>
...
if (isset($_POST['submit'])){
  ...
  $query = "SELECT * FROM internalusers WHERE customerID = 1"; 
  ...
  if($oldpassword == $db_userpassword){
    ...
    if($newpassword1cln == $newpassword2cln){
      ...
      $Chngpasswdquery = "UPDATE Customer SET passwords = '{$newpassword2cln}' WHERE customerID = 1";
