  ...
  <div class="container py-4">
    <header class="pb-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-4">Tellers page</span>
      </a>
    </header>

    <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid">
        <h1 class="display-5 fw-bold">Welcome Teller's name</h1>
    ...
    <div class="col-sm-12 col-md-6 col-lg-4 mb-4"><div class="card text-white card-has-bg click-col " >
        <div class=" d-flex flex-column bg-dark">
         <a href="" style="text-decoration: none;"><div class="card-body">
            ...
            <p class="text-white">Issue deposit</p>
            <br>
            <br>
            </h4>
          </div>
    ...
    <div class="col-sm-12 col-md-6 col-lg-4 mb-4"><div class="card text-white card-has-bg click-col " >
        <div class=" d-flex flex-column bg-dark">
         <a href="" style="text-decoration: none;"><div class="card-body">
            <h4 class="card-title mt-0 ">
            <p class="text-white">Issue Withdraw</p>
            <br>
            <br>
            </h4>
          </div>
