...
<main>
  ...
  <header class="pb-3 mb-4 border-bottom d-flex justify-content-between">
      <a href="Customer.php" class="d-flex align-items-center text-dark text-decoration-none">
      <img src="./public/image/eco-removebg-preview.png" width="90" height="32">
        <span class="fs-4 text-white">change password</span>
      </a>
      <form action="custchngpassword.php" method="post">
    ...
    <div class="p-3 mb-4 bg-light rounded-3">
      <div class="container-fluid py-3">
        ...
        <p class="col-md-8 fs-4">Customer's ID: <?php echo $db_customerid ?></p>
...
if (isset($_POST['submit'])){
  ...
  $query = "SELECT * FROM Customer WHERE customerID = {$db_customerid}"; 
  ...
  if($oldpassword == $db_userpassword){
    ...
    if($newpassword1cln == $newpassword2cln){
      ...
      $Chngpasswdquery = "UPDATE Customer SET passwords = '{$newpassword2cln}' WHERE customerID = {$db_customerid}";
